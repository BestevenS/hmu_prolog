...
% βιβλιοθήκες για server και html 
...
% βιβλιοθήκες για rdf
% Φορτώνει στην μνήμη της βιβλιοθήκες της βιβλιοθήκης rdf
:-use_module(library(rdf)).

/*
Για να έκτελέσουμε ερωτήσεις στην SWI-
Prolog χρησιμοποιούμε τα κατηγορήματα
?-rdf(S, P, O).
?-rdf(S, P, O, G).
Αυτά είναι αληθή αν η τριπλέτα <S, P, O> υπάρχει 
και υπάρχει ο γράφος G.
*/

:-load_rdf('file.rdf', List).
% Αποθηκεύει στη μεταβλητή List όλες τις τριπλέτες
% που βρίσκονται στο αρχείο example.rdf
